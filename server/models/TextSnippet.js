...
TextSnippet.add({
	...
	location: { type: Types.Select, options: 'submit narrative, submit narrative thanks, narratives intro, pathways intro, resources intro, quiz landing intro, quiz results intro', required: true, initial: true, note: 'Page snippet shows on.' },    
